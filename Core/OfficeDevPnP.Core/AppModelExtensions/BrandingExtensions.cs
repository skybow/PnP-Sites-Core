...
namespace Microsoft.SharePoint.Client
{
    ...
    public static partial class BrandingExtensions
    {
        ...
        public static ListItem GetPageLayoutListItemByName(this Web web, string pageLayoutName)
        {
            ...
            web.Context.ExecuteQueryRetry();
            var partMasterCatalogPath = "_catalogs/masterpage";
            if (pageLayoutName.IndexOf(partMasterCatalogPath) > -1 && masterPageGallery.RootFolder.ServerRelativeUrl.IndexOf(partMasterCatalogPath) > -1)
            {
                pageLayoutName = pageLayoutName.Substring(partMasterCatalogPath.Length + 1);
            }
            var fileRefValue = string.Format("{0}/{1}{2}", masterPageGallery.RootFolder.ServerRelativeUrl, pageLayoutName, pageLayoutName.EndsWith(".aspx") ? string.Empty : ".aspx");
